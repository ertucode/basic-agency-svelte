	...
	const engagements: ComponentProps<Engagement>[] = [
		{
			...
			header: 'Google',
			href: '/case-studies/google-ecommerce-web-design',
		...
		},
		{
			...
			header: 'Patagonia',
			href: '/case-studies/patagonia-ecommerce-website',
...
<div class="engagement-top xl:gap-6 xl:grid flex gap-0 mt-5">
	<div>00</div>
